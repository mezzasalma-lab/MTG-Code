...
# ==============================================================================
# Este arquivo e' uma copia FIEL e INTOCADA de urdragon_goldfish_v1.py como ele
# era ANTES do commit 42fe8ff ("Ur-Dragon: porta modo de resiliencia do Megatron
# (6 categorias + counterspell)"), preservada a pedido do usuario como copia de
# seguranca -- nao e' mantida/atualizada daqui pra frente, so' existe como
# referencia do estado pre-modo-de-resiliencia.
#
# O arquivo ativo (urdragon_goldfish_v1.py) ja garante o mesmo comportamento --
...
#   git show 42fe8ff^:ur-dragon-wurbg/urdragon_goldfish_v1.py
# ==============================================================================
