...
# ==============================================================================
# Este arquivo e' uma copia FIEL e INTOCADA de heibai_goldfish_v1.py como ele era
# ANTES do commit dd9677e ("Hei Bai: porta modo de resiliencia do Megatron/
# Ur-Dragon mesmo com 2 lacunas estruturais"), preservada a pedido do usuario
# como copia de seguranca -- nao e' mantida/atualizada daqui pra frente, so'
# existe como referencia do estado pre-modo-de-resiliencia.
#
# O arquivo ativo (heibai_goldfish_v1.py) ja garante o mesmo comportamento --
# simulate_one()/run_batch() la' sao 100% bit-identicos a este aqui (validado com
# 5.000 seeds, ver checklist-oraculo.md/goldfish-log.md). Este arquivo e' uma
# camada extra de seguranca, nao a unica garantia.
#
# Recuperavel a qualquer momento tambem via:
#   git show dd9677e^:hei-bai-wurbg/heibai_goldfish_v1.py
# ==============================================================================
