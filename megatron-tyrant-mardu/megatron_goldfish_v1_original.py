# ==============================================================================
# COPIA DE SEGURANCA -- ORIGINAL (antes das extensoes de resiliencia desta sessao, 2026-09-20)
# ==============================================================================
# Este arquivo e' uma copia FIEL e INTOCADA de megatron_goldfish_v1.py como ele
# era no commit 82dc479 ("Megatron: registra Partida #1 (goldfish manual real,
# vitoria T6)") -- ou seja, DEPOIS do fix do Cityscape Leveler e do registro da
# Partida #1 (nao sao mudancas de resiliencia), mas ANTES das extensoes reais do
# modo de resiliencia feitas nesta sessao: discard aleatorio (a011190), board
# wipe (a13507d), counterspell (593c94f), graveyard hate + fix central do
# Blightsteel Colossus (bc4f919).
#
# IMPORTANTE: o modo de resiliencia deste deck NAO comecou nesta sessao -- 3
# categorias (remocao inteligente, ataque com bloqueio, perfis de token) ja
# existiam desde 2026-09-16, de sessoes anteriores. Este arquivo AINDA TEM essas
# 3 categorias (elas nao sao 'extensoes desta sessao') -- so' nao tem as 4 novas
# categorias/fix listadas acima. Pra voltar ainda mais, antes do modo de
# resiliencia existir por completo, usar um commit anterior a 2026-09-16.
#
# O arquivo ativo (megatron_goldfish_v1.py) ja garante o mesmo comportamento do
# goldfish padrao -- simulate_one()/run_batch() la' continuam identicos ao longo
# de toda essa evolucao (validado por equivalencia bit-a-bit em cada rodada, ver
# checklist-oraculo.md/goldfish-log.md). Este arquivo e' uma camada extra de
# seguranca, nao a unica garantia.
#
# Recuperavel a qualquer momento tambem via:
#   git show 82dc479:megatron-tyrant-mardu/megatron_goldfish_v1.py
# ==============================================================================
